...
-  Simpler Does It: Generating SemanticLabels with Objectness Guidance. [Amirul Islam](https://www.cs.ryerson.ca/~amirul/), [Matthew Kowal](https://mkowal2.github.io/),[Sen Jia](https://github.com/SenJia), [Kosta Derpanis](https://www.cs.ryerson.ca/~kosta/), and [Neil Bruce](https://www.cs.ryerson.ca/~bruce/). (Under Review @ [CVPR 2021](http://cvpr2021.thecvf.com/))
